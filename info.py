...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/devmovies2')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/devbots2')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/howtodownloadmoviestamilhd/65')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'NONE OF YOUR BUSINESS')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ''))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/champaklalbot')
